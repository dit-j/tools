...
public class ImageUtil {
    ...
    /**
     * Verkleinert ein Bild zu einer bestimmten Groesse.
     * Proportionen werden dabei beibehalten.
     * 
     * @param image
     *            Quelle
     * @param newHeight
...
//        BufferedImage bufferedImage = new BufferedImage(newW, newHeight, BufferedImage.TYPE_BYTE_INDEXED, (IndexColorModel) image.getColorModel());
...
//    }
    ...
    /**
     * Creates a <code>BufferedImage</code> from an
     * <code>Image</code>. This method can function on a
     * completely headless system. This especially includes
     * Linux and Unix systems that do not have the X11
     * libraries installed, which are required for the AWT
     * subsystem to operate. The resulting image will be
     * smoothly scaled using bilinear filtering.
     * 
     * @param source
